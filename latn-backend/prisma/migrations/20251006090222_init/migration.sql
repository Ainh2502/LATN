...
-- CreateEnum
CREATE TYPE "FulfillmentStatus" AS ENUM ('DRAFT', 'PENDING', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED');
...
CREATE TABLE "Order" (
    ...
    "fulfillmentStatus" "FulfillmentStatus" NOT NULL DEFAULT 'DRAFT',
    "appliedPromotionJson" JSONB,
...
-- CreateIndex
CREATE UNIQUE INDEX "UserProvider_provider_providerUid_key" ON "UserProvider"("provider", "providerUid");
...
-- CreateIndex
CREATE INDEX "Banner_visibleFrom_idx" ON "Banner"("visibleFrom");

-- CreateIndex
CREATE INDEX "Banner_visibleTo_idx" ON "Banner"("visibleTo");
